-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'IN_PREPARATION', 'FINISHED', 'DELIVERED');

-- CreateEnum
CREATE TYPE "ConsupmtionMethod" AS ENUM ('TAKEAWAY', 'DINE_IN');
...
CREATE TABLE "Order" (
    ...
    "consupmtionMethod" "ConsupmtionMethod" NOT NULL,
    "restaurantId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
